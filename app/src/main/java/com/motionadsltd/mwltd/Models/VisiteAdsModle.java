...
public class VisiteAdsModle {
    private String ad1,ad2,ad3,ad4,ad5,uid,time,last;
    int use,click;

    public VisiteAdsModle() {
    }

    public VisiteAdsModle(String ad1, String ad2, String ad3, String ad4, String ad5, String uid, String time, String last, int use, int click) {
        this.ad1 = ad1;
        this.ad2 = ad2;
        this.ad3 = ad3;
        this.ad4 = ad4;
